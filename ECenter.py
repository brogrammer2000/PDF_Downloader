...
for (i,j) in zip(market_name,city_codes): #for loop to loop through the location keys
 url = "https://static.edeka.de/media/handzettel/MINDEN/"+j+"/blaetterkatalog/pdf/complete.pdf" #API URL
